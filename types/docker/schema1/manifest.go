...
// Applications requiring a marshaled signed manifest should simply use Raw directly, since the content produced by json.Marshal will be compacted and will fail signature checks.
